...
class US_ARMY_RANGER_RFL : US_ARMY_DEFAULT_UCP { // US Army Ranger (Rifleman)
	...
	secondary[] = { "rhsusf_weap_m1911a1"};
	launcher[] = { "" };
	magazines[] = { "rhs_mag_20Rnd_SCAR_762x51_m61_ap", 7, "rhsusf_mag_7x45acp_MHP", 3 };
	items[] += { "ACE_EarPlugs",1 };
	binoculars[] = { "rhsusf_bino_lerca_1200_tan" };
	compass[] = { "ItemCompass" };
...
magazines[] = { "rhs_mag_30Rnd_556x45_Mk318_SCAR_Ranger", 7, "rhsusf_mag_7x45acp_MHP", 2 };
...
class US_ARMY_RANGER_SNP : US_ARMY_RANGER_RFL { // US Army Ranger (Sniper)
	...
	secondary[] = { "rhsusf_weap_m1911a1"};
	launcher[] = { "" };
	magazines[] = { "rhsusf_5Rnd_762x51_m993_Mag", 8, "rhsusf_5Rnd_762x51_m118_special_Mag", 6 , "rhsusf_mag_7x45acp_MHP", 3 };
