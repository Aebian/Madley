...
class US_AIRFORCE_SECF_SNP : US_ARMY_DEFAULT_UCP // Airforce Security Forces Sniper
{
	...
	secondary[] = { "rhsusf_weap_m9", "rhsusf_mag_15Rnd_9x19_JHP" };
	launcher[] = { "" };
	magazines[] = { "rhsusf_5Rnd_762x51_m993_Mag", 8, "rhsusf_5Rnd_762x51_m118_special_Mag", 6 , "rhsusf_mag_15Rnd_9x19_JHP", 3 };
	items[] += { "ACE_packingBandage",2,"ACE_fieldDressing",2, "ACE_EarPlugs",1,"rhs_mag_m18_red",2, "rhsusf_mag_15Rnd_9x19_JHP", 2, "rhs_mag_30Rnd_556x45_M855A1_EPM_Ranger_Tracer_Red", 8};
	lrradios[] =  {"ACRE_PRC148"};
	binoculars[] = { "rhsusf_bino_lerca_1200_tan" };
	compass[] = { "ItemCompass" };
	goggles[] = { "rhs_googles_black" };
