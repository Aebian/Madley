...
class US_NAVY_PARAM : CommonAmerica // Navy Paramedic
{
	...
	launcher[] = {""};
	magazines[] = {"rhs_mag_30Rnd_556x45_Mk318_Stanag",8,"rhsusf_mag_7x45acp_MHP",2 };
	items[] += {"ACE_fieldDressing",6,"ACE_elasticBandage",6,"ACE_quikclot",6,"ACE_packingBandage",6,"ACE_bloodIV",2,"ACE_epinephrine",8,"ACE_morphine",8,"ACE_tourniquet",4,"ACE_splint",4,"rhs_mag_m18_green",3};
	binoculars[] = {"Binocular"};
	compass[] = {"ItemCompass"};
	goggles[] = {"G_Aviator"};
	gps[] = {"ItemGPS"};
